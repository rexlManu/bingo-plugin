    ...
    static {
        try {
            ...
            if (FastReflection.isRepackaged()) {
                ...
                FastReflection
                    .nmsOptionalClass(null, "ScoreboardServer$Action")
                    .isPresent()
            ) {
    ...
    private void sendTeamPacket(int score, TeamMode mode) throws Throwable {
        ...
        if (mode == TeamMode.CREATE || mode == TeamMode.UPDATE) {
            ...
            if (line == null || line.equals(Component.empty())) {
                prefix = Component.text(COLOR_CODES[score] + ChatColor.RESET);
            ...
            //        (suffix != null && suffix.length() > maxLength)
            //      ) {
            ...
            if (VersionType.V1_17.isHigherOrEqual()) {
                ...
                setComponentField(team, suffix == null ? Component.empty() : suffix, 2); // Suffix
